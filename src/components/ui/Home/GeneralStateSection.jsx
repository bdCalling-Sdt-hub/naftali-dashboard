...
const GeneralStateSection = () => {
  ...
  return (
    <div className="grid md:grid-cols-5 gap-6 md:h-[210px]">
      <div className="bg-white rounded-2xl py-0 px-6 flex flex-col items-center justify-start gap-4">
        ...
        <div className="flex flex-col items-start justify-center">
          <div className="flex gap-10">
            <div className="flex flex-col border-2 border-dashed bg-green-50 border-green-300 px-4 rounded-2xl items-center">
              <h1 className="text-xl font-semibold">Online</h1>
              <h1>{state?.totalActiveUsers?.online}</h1>
            </div>
            <div className="flex flex-col border-2 border-dashed bg-red-50 border-red-300 px-4 rounded-2xl items-center">
